 ...
 *
 */
public class BasicPool_MySQL_Test
{
   @Before
...
//       config.addDataSourceProperty("url", "jdbc:mysql://localhost:3306/jnuyt_test");
      config.setDriverClassName("com.mysql.cj.jdbc.Driver");
      config.setJdbcUrl("jdbc:mysql://localhost:3306/jnuyt_test");
